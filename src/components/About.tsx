  ...
  return (
    <section id="about" className="container about">
      ...
      <p>
        ...
        De igual forma, he trabajado con tecnologías como Python, C#, Tableau, Unity y Blender, lo que me permite tener una visión más amplia en el desarrollo de soluciones. <br />
